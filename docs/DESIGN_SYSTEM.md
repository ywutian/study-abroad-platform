...
| 原则         | 描述                                              |
| ------------ | ------------------------------------------------- |
| **专业可信** | 深靛蓝+砖红学院配色，传递权威与信任感             |
| **简洁克制** | 去除发光阴影和复杂渐变，使用实体边框              |
| **书卷气**   | DM Sans + Source Serif 字体组合，兼具现代与学术感 |
...
| 名称             | 亮色模式               | 暗色模式               | 用途                 |
| ---------------- | ---------------------- | ---------------------- | -------------------- |
| **Primary**      | `oklch(0.45 0.12 250)` | `oklch(0.60 0.14 250)` | 主要操作、链接、重点 |
| **Accent Brand** | `oklch(0.55 0.15 30)`  | `oklch(0.60 0.15 30)`  | 强调、徽章、高亮     |
| **Success**      | `oklch(0.55 0.12 145)` | `oklch(0.62 0.12 145)` | 成功状态、录取       |
| **Warning**      | `oklch(0.65 0.12 70)`  | `oklch(0.72 0.12 70)`  | 警示、候补           |
| **Destructive**  | `oklch(0.50 0.15 25)`  | `oklch(0.55 0.15 25)`  | 错误、拒绝、删除     |
...
| 元素 | 亮色          | 暗色          |
| ---- | ------------- | ------------- |
| 背景 | `oklch(0.98)` | `oklch(0.12)` |
| 卡片 | `oklch(1)`    | `oklch(0.17)` |
| 主色 | `oklch(0.45)` | `oklch(0.60)` |
| 边框 | `oklch(0.92)` | `oklch(0.25)` |
...
- [x] 字体更换为 DM Sans + Source Serif 4
- [x] 主色更换为深靛蓝 `oklch(0.45 0.12 250)`
- [x] 圆角缩小为 `0.5rem`
