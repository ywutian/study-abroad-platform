...
| **QA / Release** | [RELEASE_GATE_ONE_PAGER.md](RELEASE_GATE_ONE_PAGER.md) → [QA_RELEASE_GATE_SOP.md](QA_RELEASE_GATE_SOP.md) → [CODEX_E2E_RUNBOOK.md](CODEX_E2E_RUNBOOK.md) → [TESTING_CHECKLIST.md](TESTING_CHECKLIST.md)       |
