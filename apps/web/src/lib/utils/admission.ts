...
export const ESSAY_TYPE_STYLES: Record<EssayTypeKey, string> = {
  COMMON_APP:
    'bg-blue-500/10 dark:bg-blue-950/30 text-blue-600 dark:text-blue-400 border-blue-500/20',
  UC: 'bg-amber-500/10 dark:bg-amber-950/30 text-amber-600 dark:text-amber-400 border-amber-500/20',
  SUPPLEMENTAL:
    'bg-purple-500/10 dark:bg-purple-950/30 text-purple-600 dark:text-purple-400 border-purple-500/20',
  WHY_SCHOOL:
    'bg-teal-500/10 dark:bg-teal-950/30 text-teal-600 dark:text-teal-400 border-teal-500/20',
  OTHER: 'bg-gray-500/10 dark:bg-gray-950/30 text-gray-600 dark:text-gray-400 border-gray-500/20',
};
