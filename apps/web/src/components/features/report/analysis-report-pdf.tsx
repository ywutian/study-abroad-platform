...
const translations = {
  ...
  en: {
    title: 'AI Profile Analysis Report',
...
export function AnalysisReportPDF({ data, locale }: AnalysisReportPDFProps) {
  ...
  const overviewText = stripMarkdown(data.admissionPrediction);
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.scoreSection}>
          ...
          <View style={styles.potentialBadge}>
            <Text style={styles.potentialText}>
              +{data.projectedImprovement} {t.potential}
            </Text>
          </View>
        </View>
        ...
        {data.recommendedActivities.length > 0 && (
          <View style={styles.section}>
            ...
            {data.recommendedActivities.map((activity, i) => (
              <View key={i} style={styles.listItem}>
