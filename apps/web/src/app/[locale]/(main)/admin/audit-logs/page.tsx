...
import { ScrollText, Info, Bot } from 'lucide-react';
          ...
          <div className="mb-4 flex items-center gap-4">
            ...
            >
              ...
              <SelectContent>
                ...
                <SelectItem value="DELETE_REPORT">
                  {t('auditLogs.actions.DELETE_REPORT')}
                </SelectItem>
              </SelectContent>
            </Select>
        ...
        <TabsContent value="agent">
          <div className="mb-4 flex flex-wrap items-center gap-3">
            ...
            >
              ...
              <SelectContent>
                <SelectItem value="ALL">{t('auditLogs.allActions')}</SelectItem>
                <SelectItem value="CHAT_MESSAGE">
                  {t('auditLogs.agentActions.CHAT_MESSAGE')}
                </SelectItem>
          ...
          {agentLoading ? (
            ...
            <>
                      ...
                      {agentData.data.map((log) => (
                        <TableRow key={log.id}>
                          ...
                          <TableCell>
                            <Badge
                              variant="outline"
                              className={AGENT_STATUS_COLORS[log.status] || ''}
                            >
                              {log.status}
                            </Badge>
                          </TableCell>
              ...
              <PaginationControls
                page={agentPage}
                totalPages={Math.ceil((agentData.total || 0) / pageSize)}
