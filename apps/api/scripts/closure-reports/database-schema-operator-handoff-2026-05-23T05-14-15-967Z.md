...
Generated at: 2026-05-23T05:14:15.975Z
...
- External candidate target manifest digest sidecar: apps/api/scripts/closure-reports/database-migration-external-candidate-intake/TARGETS.sha256
- External candidate target manifest SHA-256: 82eee3b9a752d50ff6a87b721f8149040716b95540cd99640258b0c6c7c67d4d
- External candidate target manifest size bytes: 2523
- External candidate files present: 0
- External candidate SQL files present: 0
- External candidate archive files present: 0
- External generated intake files present: 8
- External exact SQL request JSON: apps/api/scripts/closure-reports/database-migration-external-candidate-intake/REQUEST.json
- External exact SQL request Markdown: apps/api/scripts/closure-reports/database-migration-external-candidate-intake/REQUEST.md
- External intake status JSON: apps/api/scripts/closure-reports/database-migration-external-candidate-intake/STATUS.json
- External intake status Markdown: apps/api/scripts/closure-reports/database-migration-external-candidate-intake/STATUS.md
