...
const BATCH: BatchTarget[] = [
  ...
  },
  {
    ...
    sourceUrl: 'https://admissions.oregonstate.edu/undergraduate-admission-deadlines',
    lastError:
  ...
  },
  {
    ...
    sourceUrl: 'https://www.uh.edu/undergraduate-admissions/apply/freshman/freshman-process/',
    lastError:
  ...
  },
  {
    ...
    sourceUrl: 'https://www.k-state.edu/admissions/undergrad/manhattan/apply/deadlines.html',
    lastError:
  ...
  },
  {
    ...
    sourceUrl: 'https://www.ucf.edu/admissions/undergraduate/question/what-is-early-action-at-ucf/',
    lastError:
  ...
  },
  {
    ...
    sourceUrl: 'https://admissions.rowan.edu/admissions-process/app-calendar-fees.html',
    lastError:
  ...
  },
  {
    ...
    sourceUrl: 'https://www.admissions.msstate.edu/apply/admission-process/freshman-admissions',
    lastError:
  ...
  },
  {
    ...
    sourceUrl: 'https://admissions.adelphi.edu/freshman/how-to-apply/decisions-deadlines-early-action/',
    lastError:
  ...
  },
  {
    ...
    sourceUrl: 'https://www.kent.edu/admissions/first-year-student-requirements',
    lastError:
  ...
  },
  {
    ...
    sourceUrl: 'https://www.bsu.edu/admissions/undergraduate-admissions/apply-now/dates-and-deadlines',
    lastError:
  ...
  },
  {
    ...
    sourceUrl: 'https://www.usd.edu/Admissions-and-Aid/Undergraduate-Admissions/Deadlines-and-Requirements',
    lastError:
  ...
  },
  {
    ...
    sourceUrl: 'https://www.csulb.edu/admissions/first-time-first-year-student-application-process',
    lastError:
  ...
  },
  {
    ...
    sourceUrl: 'https://www.bgsu.edu/admissions/apply-now/freshmen/application-instructions.html',
    lastError:
  ...
  },
  {
    ...
    sourceUrl: 'https://www.ndsu.edu/admission/how_to_apply/first_year/timeline',
    lastError:
  ...
  },
  {
    ...
    sourceUrl: 'https://catalog.uwm.edu/admission-costs/undergraduate-admission/',
    lastError:
  ...
  },
  {
    ...
    sourceUrl: 'https://www.wright.edu/admissions/undergraduate/dates-and-deadlines',
    lastError:
  ...
  },
  {
    ...
    sourceUrl: 'https://www.cmich.edu/admissions-aid/undergraduate/freshmen/how-to-apply',
    lastError:
  ...
  },
  {
    ...
    sourceUrl: 'https://www.wichita.edu/admissions/undergraduate/blog/2022/09_20_Dates_and_Deadlines.php',
    lastError:
  ...
  },
  {
    ...
    sourceUrl: 'https://www.jmu.edu/admissions/apply/first-year/early-action.shtml',
    lastError:
  ...
  },
  {
    ...
    sourceUrl: 'https://www.gvsu.edu/admissions/undergraduate-admissions-requirements-30.htm',
    lastError:
  ...
  },
  {
    ...
    sourceUrl: 'https://www.towson.edu/admissions/undergrad/freshmen/deadlines.html',
    lastError:
      'Has non-binding Early Action (Nov 1 deadline) but does not publish a round-specific EA admit rate — no EA/RD breakdown disclosed.',
  },
  {
    ...
    sourceUrl: 'https://www.csus.edu/apply/admissions/application-process/freshman-process.html',
    lastError:
