...
const BATCH: BatchTarget[] = [
  // ── CLOSED: credible, source-verified non-binding EA admit rate ────────────
  {
    ...
    value: 7.0,
    sourceUrl:
      'https://dailytrojan.com/2024/02/04/usc-acceptance-rate-class-of-2028-expected-9-2-record-low/',
    confidence: 0.88,
    tier: 'SCRAPED',
  ...
  },
  {
    ...
    value: 15.89,
    sourceUrl:
      'https://www.ivycoach.com/the-ivy-coach-blog/early-decision-early-action/georgia-tech-early-action-admission-statistics/',
    confidence: 0.85,
    tier: 'SCRAPED',
  ...
  },
  {
    ...
    value: 46.6,
    sourceUrl:
      'https://www.collegetransitions.com/blog/how-to-get-into-the-university-of-maryland/',
    confidence: 0.82,
    tier: 'SCRAPED',
  ...
  },
  {
    ...
    value: 34.0,
    sourceUrl:
      'https://www.collegekickstart.com/blog/item/university-of-georgia-admits-9000-early-action-applicants-to-the-class-of-2028',
    confidence: 0.9,
    tier: 'SCRAPED',
  ...
  },
  {
    ...
    value: 4.7,
    sourceUrl:
      'https://huntnewsnu.com/79113/campus/northeastern-acceptance-rate-hits-all-time-low-of-5-2-after-record-application-cycle-sees-nearly-100000-applications/',
    confidence: 0.82,
    tier: 'SCRAPED',
  ...
  // ── UNAVAILABLE: no non-binding early round at all (ED-only) ───────────────
  {
    ...
    lastError:
      'No Early Action program — WashU offers only binding Early Decision (ED I/II).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError:
      'No Early Action program — NYU offers only binding Early Decision (ED I/II).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError:
      'No Early Action program — Boston College offers only binding Early Decision (ED I/II).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError:
      'No Early Action program — Tufts offers only binding Early Decision (ED I/II).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError:
      'No Early Action program — Boston University offers only binding Early Decision (ED I/II).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError:
      'No Early Action program — Lehigh offers only binding Early Decision (ED I/II).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError:
      'No Early Action program — University of Rochester offers only binding Early Decision (ED I/II).',
  },
  ...
  // ── UNAVAILABLE: no early round at all (UC single application window) ──────
  {
    ...
    sourceUrl:
      'https://www.ucdavis.edu/admissions/undergraduate/freshman/timeline',
    lastError:
      'No Early Action program — all UC campuses use a single Oct 1–Dec 1 application window with no EA/ED option.',
  },
  {
    status: 'UNAVAILABLE',
  ...
  },
  {
    ...
    lastError:
      'No general Early Action program — UCSB uses the standard UC Oct 1–Dec 1 window; its only "early action" is restricted to California EOP students and publishes no round-specific admit rate.',
  },
  ...
  // ── UNAVAILABLE: no early round at all (single review window) ──────────────
  {
    ...
    lastError:
      'No Early Action program — UW Seattle uses a single Nov 15 application deadline with no EA/ED option; decisions made only after all applications reviewed.',
  },
  ...
  // ── UNAVAILABLE: has EA but no published round-specific admit rate ─────────
  {
    ...
    sourceUrl:
      'https://www.collegetransitions.com/blog/how-to-get-into-ut-austin/',
    lastError:
      'Has non-binding Early Action but does not publish a round-specific EA admit rate (only the overall Class of 2028 rate of 26.6% is disclosed).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError:
      'Has non-binding Early Action but does not publish a round-specific EA admit rate (no EA/RD breakdown in the Common Data Set or admissions data portal).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError:
      'Has non-binding Early Action but does not publish round-specific EA/RD admit rates (only the overall Class of 2028 rate of ~42.4% is disclosed).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError:
      'Has non-binding Early Action but does not publish a round-specific EA admit rate (no EA acceptance data in the Common Data Set).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    sourceUrl:
      'https://www.ivycoach.com/the-ivy-coach-blog/early-decision-early-action/ohio-state-university-early-action-admission-statistics/',
    lastError:
      'Has non-binding Early Action but does not publish a round-specific EA admit rate (Ohio State releases no EA/RD breakdown).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    sourceUrl:
      'https://www.ivycoach.com/the-ivy-coach-blog/early-decision-early-action/purdue-university-early-action-admission-statistics/',
    lastError:
      'Has non-binding Early Action but does not publish a round-specific EA admit rate (Purdue releases EA application volume only, no EA admit count or rate).',
  },
  {
    status: 'UNAVAILABLE',
  ...
  },
  {
    ...
    sourceUrl: 'https://admissions.tc.umn.edu/competitive-admission',
    lastError:
      'Has non-binding Early Action (EA I/II) but does not publish a round-specific EA admit rate (no EA/RD breakdown disclosed). Duplicate school record of University of Minnesota Twin Cities.',
  },
  {
    status: 'UNAVAILABLE',
    ...
    sourceUrl:
      'https://www.villanova.edu/university/undergraduate-admission/applying-to-villanova/admission-profile.html',
    lastError:
      'Has non-binding Early Action but does not publish a round-specific EA admit rate (only Early Decision and overall Class of 2028 rates are disclosed).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    sourceUrl:
      'https://www.ivycoach.com/the-ivy-coach-blog/early-decision-early-action/tulane-university-early-decision-action-admission-statistics/',
    lastError:
      'Has non-binding Early Action but has not published a round-specific EA admit rate for the Class of 2028 (Class of 2028 EA statistics not yet released; only the Class of 2027 EA rate is on record).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    sourceUrl:
      'https://www.ivycoach.com/the-ivy-coach-blog/early-decision-early-action/case-western-reserve-early-decision-early-action-admission-statistics/',
    lastError:
      'Has non-binding Early Action but has not published a round-specific EA admit rate for the Class of 2028 (Class of 2028 EA statistics not released; only the Class of 2027 EA rate is on record).',
  },
  ...
  // ── UNAVAILABLE: early round restricted to a sub-population, no rate ───────
  {
    ...
    lastError:
      'No general Early Action program — Texas A&M offers Early Action only to College of Engineering applicants and publishes no round-specific EA admit rate.',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError:
      'No general Early Action program — Wake Forest offers Early Action only to first-generation college applicants and publishes no round-specific EA admit rate.',
  },
];
