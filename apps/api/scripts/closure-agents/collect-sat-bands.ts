...
const ENTRIES: SchoolEntry[] = [
  ...
  },
  {
    ...
    sat75: 1180,
    sourceUrl:
      'https://bigfuture.collegeboard.org/colleges/university-of-wisconsin-milwaukee/admissions',
    confidence: 0.78,
    tier: 'OFFICIAL',
  ...
  },
  {
    ...
    sat75: 1460,
    sourceUrl:
      'https://www.prepscholar.com/sat/s/colleges/Worcester-Polytechnic-Institute-sat-scores-GPA',
    confidence: 0.8,
    tier: 'SCRAPED',
  ...
  },
  {
    ...
    sat75: 1400,
    sourceUrl:
      'https://www.collegesimply.com/colleges/missouri/saint-louis-university-main-campus/admission-chances-sat-score/',
    confidence: 0.75,
    tier: 'SCRAPED',
...
async function main() {
  ...
  for (const e of ENTRIES) {
    ...
    if (effectiveStatus === 'CLOSED' && e.sat25 != null && e.sat75 != null) {
      ...
      const err75 = err25
        ? null
        : await writeProvenance(e.schoolId, 'sat75', e.sat75, e);
    ...
    if (effectiveStatus === 'CLOSED') {
      closed += 1;
      console.log(
        `  CLOSED       ${e.name} => sat25=${e.sat25} sat75=${e.sat75}  [${e.sourceUrl}]`,
      );
