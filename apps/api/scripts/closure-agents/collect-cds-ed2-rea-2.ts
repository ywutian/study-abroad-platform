...
const BATCH: SchoolEntry[] = [
  {
    ...
    ed2: {
      ...
      status: 'UNAVAILABLE',
      sourceUrl: 'https://content-calpoly-edu.s3.amazonaws.com/ir/1/images/CDS-2024-2025_final.pdf',
      lastError:
  ...
  },
  {
    ...
    ed2: {
      ...
      status: 'UNAVAILABLE',
      sourceUrl: 'https://www.scad.edu/content/when-should-i-apply-and-when-are-application-deadlines',
      lastError:
  ...
  },
  {
    ...
    ed2: {
      ...
      status: 'UNAVAILABLE',
      sourceUrl: 'https://ir.provost.duke.edu/sites/default/files/CDS-2024-25-Final-2.pdf',
      lastError:
  ...
  },
  {
    ...
    ed2: {
      ...
      status: 'UNAVAILABLE',
      sourceUrl: 'https://carleton-wp-production.s3.amazonaws.com/uploads/sites/292/2025/07/2024-2025-CDS_06032025.pdf',
      lastError:
  ...
  },
  {
    ...
    ed2: {
      ...
      status: 'UNAVAILABLE',
      sourceUrl: 'https://apply.jhu.edu/how-to-apply/application-deadlines-requirements/early-decision/',
      lastError:
  ...
  },
  {
    ...
    ed2: {
      ...
      status: 'UNAVAILABLE',
      sourceUrl: 'https://www.haverford.edu/admission/applying/application-instructions',
      lastError:
  ...
  },
  {
    ...
    ed2: {
      ...
      status: 'UNAVAILABLE',
      sourceUrl: 'https://opir.columbia.edu/sites/opir.columbia.edu/files/content/Common%20Data%20Set/2024-25_Columbia_College_and_Columbia_Engineering_CDS.pdf',
      lastError:
  ...
  },
  {
    ...
    ed2: {
      ...
      status: 'UNAVAILABLE',
      sourceUrl: 'https://bpb-us-w2.wpmucdn.com/voices.uchicago.edu/dist/8/2077/files/2025/08/CDS_2024-2025_to_publish.pdf',
      lastError:
