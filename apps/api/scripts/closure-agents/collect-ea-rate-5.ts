...
const BATCH: BatchTarget[] = [
  // ── UNAVAILABLE: has non-binding EA but no published round-specific rate ────
  {
    ...
    sourceUrl:
      'https://www.american.edu/admissions/first-year/decision-plans-and-deadlines.cfm',
    lastError:
      'Has non-binding Early Action (introduced in the 2024-25 cycle) but does not publish a round-specific EA admit rate — only Early Decision and overall rates are disclosed.',
  },
  {
    status: 'UNAVAILABLE',
    ...
    sourceUrl:
      'https://www.wpi.edu/admissions/undergraduate/apply/application-options',
    lastError:
      'Has non-binding Early Action (two rounds) but does not publish a round-specific EA admit rate; Common Data Set C22 is Yes/No-only and carries no EA applicant/admit counts. Third-party "early acceptance rate" figures conflict (Niche 68.9%, others 64.5%).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError:
      'Has non-binding Early Action (Nov 1 deadline) but does not publish a round-specific EA admit rate — only an overall acceptance rate is disclosed.',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError:
      'Has non-binding Early Action (Nov 1 deadline) but does not publish a round-specific EA admit rate; CollegeData and other sources report only an overall rate, with no EA/RD breakdown.',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError:
      'Has non-binding Early Action (confirmed in Temple Common Data Set C22) but does not publish a round-specific EA admit rate; CDS C22 carries no EA applicant/admit counts and third-party EA figures are estimates only.',
  },
  {
    status: 'UNAVAILABLE',
    ...
    sourceUrl:
      'https://drexel.edu/admissions/apply/undergrad-instructions/first-year-instructions/early-decision-early-action',
    lastError:
  ...
  },
  {
    ...
    lastError:
      'Has non-binding Early Action (new EA model replacing rolling admission, ~25,000 EA decisions released for fall 2026) but does not publish a round-specific EA admit rate.',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError:
      'Has non-binding Early Action (Nov 15 deadline) but does not publish a round-specific EA admit rate; the "early acceptance rate" figure is a third-party estimate, not an institution-published EA rate.',
  },
  {
    status: 'UNAVAILABLE',
  ...
  },
  {
    ...
    sourceUrl:
      'https://onthelawn.auburn.edu/2025/10/17/fall-2026-freshmen-admissions-process-dates-deadlines-decision-types-and-next-steps/',
    lastError:
      'Has non-binding Early Action (multiple EA deadlines) but does not publish a round-specific EA admit rate — no EA/RD breakdown disclosed.',
  },
  {
    status: 'UNAVAILABLE',
    ...
    sourceUrl:
      'https://sc.edu/about/offices_and_divisions/undergraduate_admissions/apply/for_freshmen/',
    lastError:
      'Has non-binding Early Action (Oct 15 deadline, introduced fall 2022) but does not publicly disclose a round-specific EA admit rate.',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError:
      'Has a non-binding Early Action / merit-scholarship priority deadline (Dec 1) but does not publish a round-specific EA admit rate.',
  },
  {
    status: 'UNAVAILABLE',
  ...
  },
  {
    ...
    lastError:
      'Has non-binding Early Action (Nov 1 deadline) but does not publish a round-specific EA admit rate; the "early acceptance rate" figure is a third-party estimate, not an institution-published EA rate.',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError:
      'Has non-binding Early Action (EA I/II) but does not publish a round-specific EA admit rate — no EA/RD breakdown disclosed.',
  },
  {
    status: 'UNAVAILABLE',
  ...
  },
  {
    ...
    lastError:
      'Has a non-binding Early Action track (Dec 1 deadline) but does not publish a round-specific EA admit rate — no EA/RD breakdown disclosed.',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError:
      'No non-binding Early Action program — SDSU is a CSU campus and admits via the Cal State Apply Regular Decision cycle with no general EA round.',
  },
  {
    status: 'UNAVAILABLE',
  ...
  },
  {
    ...
    lastError:
      'Has non-binding Early Action (Nov 10 deadline) but does not publish a round-specific EA admit rate; the school explicitly states no preference is given to early applicants.',
  },
  {
    status: 'UNAVAILABLE',
    ...
    sourceUrl:
      'https://www.ou.edu/admissions/apply/early-action-admission-deadline',
    lastError:
      'Has non-binding Early Action (Nov 1 deadline) but does not publish a round-specific EA admit rate — no EA/RD breakdown disclosed.',
  },
  {
  ...
  },
  {
    ...
    sourceUrl:
      'https://catalogue.uvm.edu/undergraduate/admissioninfo/admissionsprograms/',
    lastError:
      'Has non-binding Early Action (Nov 1 deadline) but does not publish a round-specific EA admit rate — no EA/RD breakdown disclosed.',
  },
  ...
  // ── UNAVAILABLE: no non-binding early round at all (UC/CSU system) ──────────
  {
    ...
    lastError:
      'No Early Action program — UC Riverside, like all University of California campuses, admits only via the single UC Regular Decision cycle (Oct 1–Dec 1 filing period).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError:
      'No Early Action program — UC Santa Cruz, like all University of California campuses, admits only via the single UC Regular Decision cycle.',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError:
      'No Early Action program — UC Merced, like all University of California campuses, admits only via the single UC Regular Decision cycle.',
  },
  ...
  // ── UNAVAILABLE: no non-binding early round (ED-only) ──────────────────────
  {
    ...
    lastError:
      'No Early Action program — Clarkson offers only binding Early Decision (Dec 1) alongside Regular Decision (Jan 15) for first-year applicants.',
  },
  ...
  // ── UNAVAILABLE: no early round (rolling / priority-deadline admission) ─────
  {
    ...
    lastError:
      'No Early Action program — USF does not offer EA or ED; all first-year applicants are reviewed in a single Regular Decision cycle.',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError:
      'No Early Action program — Mizzou uses rolling admission with a Dec 1 scholarship priority date, no EA/ED option.',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError:
      'No Early Action program — the University of Alabama uses rolling admission with a Dec 5 scholarship priority deadline, no EA/ED option.',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError:
      'No Early Action program — ASU uses rolling review with a Nov 1 priority date and Jan 15 regular date, no EA/ED option.',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError:
      'No general non-binding Early Action program — UT Dallas reviews applications on a priority-deadline holistic basis with no EA/ED round.',
  },
  {
    status: 'UNAVAILABLE',
    ...
    sourceUrl:
      'https://www.iastate.edu/admission-and-aid/admissions/first-year-students/first-year-checklist',
    lastError:
      'No Early Action program — Iowa State uses rolling admission with no EA/ED option (the CAP program is a separate junior-year early-indication tool).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError:
      'No named non-binding Early Action plan — UNL uses a Nov 1 priority deadline within a rolling-style admission cycle, no EA/ED round.',
  },
];
