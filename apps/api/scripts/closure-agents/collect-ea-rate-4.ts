...
const BATCH: BatchTarget[] = [
  // ── CLOSED: credible, source-verified non-binding EA admit rate ────────────
  {
    ...
    value: 70.3,
    sourceUrl: 'https://www.ivycoach.com/the-ivy-coach-blog/early-decision-early-action/penn-state-university-early-action-admission-statistics/',
    confidence: 0.82,
    tier: 'SCRAPED',
  ...
  // ── UNAVAILABLE: no non-binding early round at all (ED-only) ───────────────
  {
    ...
    lastError: 'No Early Action program — UConn offers only binding Early Decision alongside Regular Decision.',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError: 'No Early Action program — William & Mary offers only binding Early Decision (ED I/II) alongside Regular Decision.',
  },
  {
    status: 'UNAVAILABLE',
    ...
    sourceUrl: 'https://www.syracuse.edu/admissions-aid/application-process/undergraduate/enrollment-options/',
    lastError: 'No Early Action program — Syracuse offers only binding Early Decision (ED I/II) alongside Regular Decision.',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError: 'No Early Action program — GW offers only binding Early Decision (ED I/II) alongside Regular Decision.',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError: 'No non-binding Early Action program — Yeshiva offers binding Early Decision and an Early Admission track for high-school juniors, but no general non-binding EA round.',
  },
  ...
  // ── UNAVAILABLE: no early round at all (rolling admission) ─────────────────
  {
    ...
    lastError: 'No Early Action program — Pitt uses rolling admission with no EA/ED option (Dec 1 scholarship priority date only).',
  },
  ...
  // ── UNAVAILABLE: no general EA program (EA-only switch, no published rate) ─
  {
    ...
    name: 'Virginia Tech',
    sourceUrl: 'https://www.ivycoach.com/the-ivy-coach-blog/early-decision-early-action/virginia-tech-early-action-admission-statistics/',
    lastError: 'Has non-binding Early Action (Virginia Tech switched to EA-only) but does not publish a round-specific EA admit rate.',
  },
  ...
  // ── UNAVAILABLE: has EA but no published round-specific admit rate ─────────
  {
    ...
    sourceUrl: 'https://seaver.pepperdine.edu/admission/application/undergraduate/apply.htm',
    lastError: 'Has non-binding Early Action but does not publish a round-specific EA admit rate (no verifiable EA acceptance data; third-party figures conflict).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    sourceUrl: 'https://www.collegetransitions.com/blog/how-to-get-into-brandeis-acceptance-rate/',
    lastError: 'Has non-binding Early Action but does not publish a round-specific EA admit rate (only Early Decision and overall rates are disclosed).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    sourceUrl: 'https://www.scu.edu/news-and-events/press-releases/2025/december-2025/news/santa-clara-university-admits-first-members-of-class-of-2030.html',
    lastError: 'Has non-binding Early Action but does not publish a round-specific EA admit rate (SCU releases only a combined EA+ED early figure; third-party EA figures conflict).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError: 'Has non-binding Early Action but does not publish a round-specific EA admit rate (no EA/RD breakdown in the Common Data Set or official channels).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    sourceUrl: 'https://admissions.miami.edu/undergraduate/about/class-profile/index.html',
    lastError: 'Has non-binding Early Action but does not publish a round-specific EA admit rate (only Early Decision and overall rates are disclosed).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError: 'Has non-binding Early Action but does not publish a round-specific EA admit rate (no official EA acceptance data; third-party estimates only).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError: 'Has non-binding Early Action but does not publish a round-specific EA admit rate (no EA/RD breakdown disclosed).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    sourceUrl: 'https://www.collegetransitions.com/blog/how-to-get-into-rpi-rensselaer/',
    lastError: 'Has non-binding Early Action but does not publish a round-specific EA admit rate (no official EA acceptance data; only a US News early figure exists).',
  },
  {
    status: 'UNAVAILABLE',
  ...
  },
  {
    ...
    lastError: 'Has non-binding Early Action but does not publish a round-specific EA admit rate (only Early Decision and overall rates are disclosed; third-party figures conflict).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError: 'Has non-binding Early Action but does not publish a round-specific EA admit rate (no official EA acceptance data available).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError: 'Has non-binding Early Action but does not publish a round-specific EA admit rate (CU Boulder gives EA applicants the same consideration as RD and discloses no EA/RD breakdown).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError: 'Has non-binding Early Action but does not publish a round-specific EA admit rate (no EA/RD breakdown disclosed; only a US News early figure exists).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError: 'Has non-binding Early Action but does not publish a round-specific EA admit rate (no official EA acceptance data).',
  },
  {
    status: 'UNAVAILABLE',
  ...
  },
  {
    ...
    sourceUrl: 'https://www.gonzaga.edu/undergraduate-admission/why-gonzaga/explore-gu/faqs',
    lastError: 'Has non-binding Early Action but does not publish a round-specific EA admit rate (no EA/RD breakdown disclosed).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError: 'Has non-binding Early Action but does not publish a round-specific EA admit rate (no EA/RD breakdown in the Common Data Set).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError: 'Has non-binding Early Action but does not publish a round-specific EA admit rate (Clemson releases no EA/RD breakdown).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError: 'Has non-binding Early Action but has stopped publishing round-specific EA admit data (no EA/RD breakdown disclosed).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    sourceUrl: 'https://www.usnews.com/best-colleges/fordham-university-2722/applying',
    lastError: 'Has non-binding Early Action but does not publish a round-specific EA admit rate (only Early Decision and overall rates are disclosed; only a US News early figure exists).',
  },
];
