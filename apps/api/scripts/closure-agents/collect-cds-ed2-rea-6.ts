...
const BATCH: SchoolEntry[] = [
  ...
  },
  {
    ...
    ed2: {
      ...
      status: 'UNAVAILABLE',
      sourceUrl: 'https://admissions.newark.rutgers.edu/apply/first-year-students',
  ...
  },
  {
    ...
    ed2: {
      ...
      status: 'UNAVAILABLE',
      sourceUrl: 'https://sc.edu/about/offices_and_divisions/undergraduate_admissions/deadlines/index.php',
  ...
  },
  {
    ...
    ed2: {
      ...
      status: 'UNAVAILABLE',
      sourceUrl: 'https://www.depaul.edu/admission/undergraduate-admission/deadlines',
  ...
  },
  {
    ...
    ed2: {
      ...
      status: 'UNAVAILABLE',
      sourceUrl: 'https://www.clarkson.edu/admissions-aid/undergraduate/how-to-apply',
