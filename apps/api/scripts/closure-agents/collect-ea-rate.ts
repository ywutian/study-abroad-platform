...
const BATCH: BatchTarget[] = [
  // ── CLOSED: credible, source-verified EA round admit rate ──────────────────
  {
    ...
    value: 8.74,
    sourceUrl:
      'https://www.thecrimson.com/article/2023/12/14/early-action-2028/',
    confidence: 0.95,
    tier: 'SCRAPED',
  ...
  },
  {
    ...
    lastError:
      'No Early Action program — Penn offers only binding Early Decision.',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError:
      'No Early Action program — Duke offers only binding Early Decision.',
  },
  {
    status: 'UNAVAILABLE',
    ...
    sourceUrl:
      'https://williamsrecord.com/465491/news/college-admits-249-out-of-record-breaking-1068-applicants-to-class-of-2028-through-early-decision/',
    lastError:
      'No Early Action program — Williams offers only binding Early Decision.',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError:
      'No Early Action program — Amherst offers only binding Early Decision.',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError:
      'No Early Action program — Harvey Mudd offers only binding Early Decision (ED I/II).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    sourceUrl:
      'https://www.swarthmore.edu/news-events/swarthmore-admits-975-to-class-2028',
    lastError:
      'No Early Action program — Swarthmore offers only binding Early Decision (ED I/II).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError:
      'No Early Action program — Wellesley offers only binding Early Decision (ED I/II).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    name: 'Pomona College',
    sourceUrl:
      'https://admissionsight.com/pomona-college-application-deadline/',
    lastError:
      'No Early Action program — Pomona offers only binding Early Decision (ED I/II).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError:
      'No Early Action program — Bowdoin offers only binding Early Decision (ED I/II).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    sourceUrl:
      'https://www.middlebury.edu/announcements/announcements/2024/09/middlebury-welcomes-class-2028',
    lastError:
      'No Early Action program — Middlebury offers only binding Early Decision (ED I/II).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError:
      'No Early Action program — Carleton offers only binding Early Decision (ED I/II).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError:
      'No Early Action program — RISD offers only binding Early Decision and Regular Decision.',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError:
      'No Early Action program — Cooper Union offers only binding Early Decision and Regular Decision.',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError:
      'No early round — Juilliard uses a single Dec 1 application deadline with audition-based admission; no EA/ED plan.',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError:
      'No Early Action program — Curtis uses a single early-December application deadline with audition-based admission.',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError:
      'No Early Action program — CalArts uses a priority deadline + rolling space-available admission; no EA/ED plan.',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError:
      'No Early Action program — Cal Poly is a CSU with a single Nov 30 application window; no non-binding EA plan.',
  },
  ...
  //    admit rate (schools publish only an overall / combined rate) ───────────
  {
    ...
    lastError:
      'Has non-binding Early Action (Nov 1) but publishes no EA-round-specific admit rate (only overall ~77% rate disclosed).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError:
      'Has non-binding Early Action (Nov 1) but publishes no EA-round-specific admit rate.',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError:
      'Has non-binding Early Action (Nov 15) alongside rolling admission, but publishes no EA-round-specific admit rate.',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError:
      'Has an early round but publishes no EA-round-specific admit rate (only overall Class of 2028 profile disclosed).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError:
      'Has non-binding Early Action (Nov 15) but publishes no EA-round-specific admit rate.',
  },
  {
    status: 'UNAVAILABLE',
  ...
  },
  {
    ...
    lastError:
      'Has Early Action (Dec 1) but publishes no EA-round-specific admit rate.',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError:
      'Has an Early Action / priority deadline (Nov 15) but publishes no EA-round-specific admit rate.',
  },
];
