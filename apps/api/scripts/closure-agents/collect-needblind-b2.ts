...
const RESOLVED: ResolvedTarget[] = [
  ...
  },
  {
    ...
    value: false,
    sourceUrl:
      'https://studentaid.emory.edu/undergraduate/apply/new-students/international.html',
    confidence: 0.96,
    tier: 'OFFICIAL',
  },
  {
    ...
    value: false,
    sourceUrl:
      'https://financialaid.washu.edu/apply-for-aid/international-applicant-process/',
    confidence: 0.95,
    tier: 'OFFICIAL',
  },
  {
  ...
  },
  {
    ...
    value: false,
    sourceUrl:
      'https://www.colgate.edu/admission-aid/apply/international-applicants',
    confidence: 0.97,
    tier: 'OFFICIAL',
  },
  {
  ...
  },
  {
    ...
    value: false,
    sourceUrl:
      'https://afa.colby.edu/apply/requirements/international-applicants/',
    confidence: 0.9,
    tier: 'OFFICIAL',
  },
  {
    ...
    value: false,
    sourceUrl:
      'https://www.bates.edu/financial-services/financial-aid/international-undergraduates/',
    confidence: 0.95,
    tier: 'OFFICIAL',
  },
  {
...
const FAILED: FailedTarget[] = [
  {
    ...
    reason:
      'No authoritative statement on need-blind/need-aware for international applicants.',
  },
  {
