...
const BATCH: SchoolEntry[] = [
  ...
  },
  {
    ...
    ed2: {
      ...
      name: 'University of Michigan, Ann Arbor',
      status: 'UNAVAILABLE',
      sourceUrl: 'https://admissions.umich.edu/apply/first-year-applicants/first-year-application-plans',
      lastError:
  ...
  },
  {
    ...
    ed2: {
      ...
      name: 'Washington University in St. Louis',
      status: 'UNAVAILABLE',
      sourceUrl: 'https://admissions.washu.edu/how-to-apply/application-dates-deadlines/',
      lastError:
  ...
  },
  {
    ...
    ed2: {
      ...
      name: 'University of Southern California',
      status: 'UNAVAILABLE',
      sourceUrl: 'https://www.koppelmangroup.com/blog/2025/5/9/early-action-strategy-for-the-university-of-southern-california-usc-2025-2026',
      lastError:
