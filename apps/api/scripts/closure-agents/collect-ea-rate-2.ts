...
const BATCH: BatchTarget[] = [
  // ── CLOSED: credible, source-verified non-binding early-round admit rate ───
  {
    ...
    value: 10.3,
    sourceUrl: 'https://thehoya.com/news/georgetown-admits-first-early-action-class-without-race-based-affirmative-action/',
    confidence: 0.92,
    tier: 'SCRAPED',
  ...
  },
  {
    ...
    value: 15.0,
    sourceUrl: 'https://admissions.nd.edu/visit-engage/stories-news/university-of-notre-dame-releases-restrictive-early-action-decisions-for-the-class-of-2028-2/',
    confidence: 0.97,
    tier: 'OFFICIAL',
  ...
  },
  {
    ...
    value: 17.4,
    sourceUrl: 'https://news.virginia.edu/content/class-2028-uva-offers-entry-nearly-2000-regular-decision-round',
    confidence: 0.93,
    tier: 'OFFICIAL',
  ...
  // ── UNAVAILABLE: no non-binding early round at all (ED-only) ───────────────
  {
    ...
    lastError: 'No Early Action program — Northwestern offers only binding Early Decision.',
  },
  {
    status: 'UNAVAILABLE',
    ...
    sourceUrl: 'https://admission.brown.edu/apply/how-apply/ivy-league-joint-statement-admissions',
    lastError: 'No Early Action program — Brown offers only binding Early Decision.',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError: 'No Early Action program — Johns Hopkins offers only binding Early Decision (ED I/II).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError: 'No Early Action program — Claremont McKenna offers only binding Early Decision (ED I/II).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError: 'No Early Action program — Hamilton offers only binding Early Decision (ED I/II).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    sourceUrl: 'https://www.haverford.edu/financial-aid/applying-financial-aid/early-decision-and-regular-decision',
    lastError: 'No Early Action program — Haverford offers only binding Early Decision (ED I/II).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    sourceUrl: 'https://admission.brown.edu/apply/how-apply/ivy-league-joint-statement-admissions',
    lastError: 'No Early Action program — Columbia offers only binding Early Decision.',
  },
  {
    status: 'UNAVAILABLE',
    ...
    sourceUrl: 'https://admission.brown.edu/apply/how-apply/ivy-league-joint-statement-admissions',
    lastError: 'No Early Action program — Cornell offers only binding Early Decision.',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError: 'No Early Action program — Vassar offers only binding Early Decision (ED I/II).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    sourceUrl: 'https://www.grinnell.edu/admission/apply/first-year/early-decision',
    lastError: 'No Early Action program — Grinnell offers only binding Early Decision (ED I/II).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError: 'No Early Action program — Colgate offers only binding Early Decision (ED I/II).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    sourceUrl: 'https://www.davidson.edu/admission-and-financial-aid/apply/early-decision',
    lastError: 'No Early Action program — Davidson offers only binding Early Decision (ED I/II).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError: 'No Early Action program — Smith offers only binding Early Decision (ED I/II).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError: 'No Early Action program — Rice offers only binding Early Decision (ED I/II).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    sourceUrl: 'https://admissions.dartmouth.edu/glossary-term/ivy-league-agreement',
    lastError: 'No Early Action program — Dartmouth offers only binding Early Decision.',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError: 'No Early Action program — Washington and Lee offers only binding Early Decision (ED I/II).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    sourceUrl: 'https://admissions.vanderbilt.edu/vandybloggers/2024/02/class-of-2028-early-decision-by-the-numbers/',
    lastError: 'No Early Action program — Vanderbilt offers only binding Early Decision (ED I/II).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError: 'No Early Action program — Colby offers only binding Early Decision (ED I/II).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError: 'No Early Action program — Bates offers only binding Early Decision (ED I/II).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError: 'No Early Action program — Barnard offers only binding Early Decision.',
  },
  {
    status: 'UNAVAILABLE',
    ...
    sourceUrl: 'https://admissions.umich.edu/apply/first-year-applicants/application-process',
    lastError: 'Has non-binding Early Action but does not publish a round-specific EA admit rate (only overall ~15.6% rate disclosed; defers/rejects many EA applicants without round breakdown).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    sourceUrl: 'https://admissions.unc.edu/apply/types-of-applications/first-year/',
    lastError: 'Has non-binding Early Action but does not publish an authoritative round-specific EA admit rate (no primary-source EA admit count for the Class of 2028; College Kickstart EA table left admits/rate blank).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    sourceUrl: 'https://collegeadmissions.uchicago.edu/apply/first-year-applicants',
    lastError: 'Has non-binding Early Action but does not publish round-specific (EA/ED/RD) admit rates — only the overall Class of 2028 rate is disclosed.',
  },
  {
    status: 'UNAVAILABLE',
    ...
    sourceUrl: 'https://apply.emory.edu/apply/first-year/plans-deadlines/index.html',
    lastError: 'No Early Action program — Emory offers only binding Early Decision (ED I/II).',
  },
  {
    status: 'UNAVAILABLE',
    ...
    lastError: 'No Early Action program — Carnegie Mellon offers only binding Early Decision.',
  },
  ...
  // ── UNAVAILABLE: no early round at all (UC single application window) ──────
  {
    ...
    sourceUrl: 'https://admissions.berkeley.edu/apply-to-berkeley/dates-deadlines/',
    lastError: 'No Early Action program — all UC campuses use a single Oct 1–Nov 30 application window with no EA/ED option.',
  },
  {
    status: 'UNAVAILABLE',
