...
const TARGETS: Target[] = [
  ...
  // ── George Washington University ──────────────────────────────────────────
  {
    ...
    value: 92,
    sourceUrl:
      'https://www.univstats.com/colleges/george-washington-university/',
    confidence: 0.85,
    tier: 'SCRAPED',
  ...
  // ── University of California, Merced ──────────────────────────────────────
  {
    ...
    value: 76.6,
    sourceUrl:
      'https://diycollegerankings.com/50-50-profile-university-california-merced/6132/',
    confidence: 0.78,
    tier: 'SCRAPED',
  ...
  // ── Pennsylvania State University (University Park) ───────────────────────
  {
    ...
    value: 93,
    sourceUrl:
      'https://bigfuture.collegeboard.org/colleges/penn-state-university-park/academics',
    confidence: 0.85,
    tier: 'SCRAPED',
  ...
  // ── University of Iowa ────────────────────────────────────────────────────
  {
    ...
    value: 90.9,
    sourceUrl:
      'https://now.uiowa.edu/news/2026/02/ui-sets-new-records-student-retention-graduation',
    confidence: 0.9,
    tier: 'OFFICIAL',
  ...
  },
  {
    ...
    value: 15,
    sourceUrl:
      'https://bigfuture.collegeboard.org/colleges/university-of-iowa/academics',
    confidence: 0.82,
    tier: 'SCRAPED',
  ...
  },
  {
    ...
    value: 22,
    sourceUrl:
      'https://bigfuture.collegeboard.org/colleges/university-of-houston/academics',
    confidence: 0.82,
    tier: 'SCRAPED',
  ...
  // ── SUNY Binghamton University ────────────────────────────────────────────
  {
    ...
    value: 90.1,
    sourceUrl:
      'https://www.binghamton.edu/offices/oir/institutional-data/cds2025.pdf',
    confidence: 0.95,
    tier: 'OFFICIAL',
  ...
  },
  {
    ...
    value: 17,
    sourceUrl:
      'https://bigfuture.collegeboard.org/colleges/north-dakota-state-university/academics',
    confidence: 0.82,
    tier: 'SCRAPED',
  ...
  // ── Indiana University-Purdue University Indianapolis (IU Indianapolis) ────
  {
    ...
    value: 72,
    sourceUrl:
      'https://www.usnews.com/best-colleges/indiana-university-indianapolis-1813',
    confidence: 0.72,
    tier: 'SCRAPED',
...
async function main() {
  ...
  const counts: Record<
    Field,
    { closed: number; unavailable: number; failed: number }
  > = {
  ...
  for (const t of TARGETS) {
    ...
    if (effectiveStatus === 'CLOSED') {
      ...
      console.log(
        `  CLOSED       [${t.field}] ${t.name} => ${t.value}  [${t.sourceUrl}]`,
      );
