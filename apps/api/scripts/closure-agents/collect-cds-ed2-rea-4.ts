...
const BATCH: SchoolEntry[] = [
  {
    ...
    ed2: {
      ...
      status: 'UNAVAILABLE',
      sourceUrl: 'https://www.nyu.edu/admissions/undergraduate-admissions/how-to-apply/all-freshmen-applicants/early-decision.html',
      lastError:
  ...
  },
  {
    ...
    ed2: {
      ...
      status: 'UNAVAILABLE',
      sourceUrl: 'https://admissions.tufts.edu/apply/applying-to-tufts/early-decision/',
      lastError:
  ...
  },
  {
    ...
    ed2: {
      ...
      status: 'UNAVAILABLE',
      sourceUrl: 'https://www.admissions.uga.edu/blog/early-action-vs-regular-decision/',
      lastError:
  ...
  },
  {
    ...
    ed2: {
      ...
      status: 'UNAVAILABLE',
      sourceUrl: 'https://admissions.tc.umn.edu/apply/freshman-application-deadlines',
      lastError:
  ...
  },
  {
    ...
    ed2: {
      ...
      status: 'UNAVAILABLE',
      sourceUrl: 'https://www.villanova.edu/university/undergraduate-admission/applying-to-villanova/dates-and-deadlines.html',
      lastError:
  ...
  },
  {
    ...
    ed2: {
      ...
      status: 'UNAVAILABLE',
      sourceUrl: 'https://www.wm.edu/admission/undergraduateadmission/how-to-apply/first-year-applicants/earlydecision/',
      lastError:
  ...
  },
  {
    ...
    ed2: {
      ...
      status: 'UNAVAILABLE',
      sourceUrl: 'https://seaver.pepperdine.edu/admission/application/undergraduate/deadlines/',
      lastError:
  ...
  },
  {
    ...
    ed2: {
      ...
      status: 'UNAVAILABLE',
      sourceUrl: 'https://www.syracuse.edu/admissions-aid/application-process/undergraduate/enrollment-options/early-decision/',
      lastError:
  ...
  },
  {
    ...
    ed2: {
      ...
      status: 'UNAVAILABLE',
      sourceUrl: 'https://www.scu.edu/admission/undergraduate/first-year-students/early-or-regular-decision/',
      lastError:
  ...
  },
  {
    ...
    ed2: {
      ...
      status: 'UNAVAILABLE',
      sourceUrl: 'https://www.brandeis.edu/admissions/apply/application-process/early-decision.html',
      lastError:
