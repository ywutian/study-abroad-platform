...
const GPA_TARGETS: GpaTarget[] = [
  ...
  },
  {
    ...
    bands: null,
    sourceUrl:
      'https://www.grinnell.edu/doc/grinnell-college-common-data-set-2024-2025',
    confidence: null,
    tier: null,
  ...
  },
  {
    ...
    bands: null,
    sourceUrl:
      'https://drive.google.com/file/d/1DTu9an407XQ3jc412TNYGutC8qfmdpeI/view',
    confidence: null,
    tier: null,
...
const TRANSFER_TARGETS: TransferTarget[] = [
  ...
  },
  {
    ...
    value: 43.3,
    sourceUrl:
      'https://www1.villanova.edu/content/dam/villanova/provost/decision_support/2024-2025-CDS_v2.pdf',
    confidence: 0.95,
    tier: 'OFFICIAL',
  ...
  },
  {
    ...
    value: 65.09,
    sourceUrl:
      'https://iuapps.iu.edu/cds/?p=index&i=home&section=D.+Transfer+Admission&year=2024&campus=Bloomington',
    confidence: 0.95,
    tier: 'OFFICIAL',
  ...
  },
  {
    ...
    value: 87.6,
    sourceUrl:
      'https://www.unh.edu/institutional-research/sites/default/files/media/2025-07/CDS-2024-2025_7.18.25.pdf',
    confidence: 0.95,
    tier: 'OFFICIAL',
  ...
  },
  {
    ...
    value: 94.62,
    sourceUrl:
      'https://www.pdx.edu/research-planning/sites/researchplanning.web.wdt.pdx.edu/files/2024-05/CDS_2023-2024%20(Updated%205-8-24%20AM).pdf',
    confidence: 0.9,
    tier: 'OFFICIAL',
  ...
  },
  {
    ...
    value: 69.85,
    sourceUrl:
      'https://www.sjsu.edu/irsa/docs/cds/20250411_CDS_2024-2025%20FINAL.pdf',
    confidence: 0.95,
    tier: 'OFFICIAL',
  ...
  },
  {
    ...
    value: 66.7,
    sourceUrl:
      'https://iuapps.iu.edu/cds/?p=index&i=home&section=D.+Transfer+Admission&year=2024&campus=IU-Indianapolis',
    confidence: 0.95,
    tier: 'OFFICIAL',
  ...
  },
  {
    ...
    value: 78.47,
    sourceUrl:
      'https://cms.artcenter.edu/assets/24118/src/ArtCenter-CDS-2024-2025.pdf',
    confidence: 0.95,
    tier: 'OFFICIAL',
  ...
  // ── UNAVAILABLE (12) ──
  {
    ...
    value: null,
    sourceUrl:
      'https://www.slu.edu/provost/office-of-institutional-research/institutional-data/index.php',
    confidence: null,
    tier: null,
  ...
  },
  {
    ...
    value: null,
    sourceUrl:
      'https://calarts.edu/admissions-aid/admissions/transfer-applicants',
    confidence: null,
    tier: null,
...
function assertBandsValid(name: string, b: GpaBands): void {
  ...
  for (const [band, frac] of Object.entries(b)) {
    if (frac < 0 || frac > 1) {
      throw new Error(
        `Sanity gate violation: ${name} band ${band}=${frac} (must be 0–1)`,
      );
    }
  }
}
