...
const BATCH: BatchTarget[] = [
  ...
  },
  {
    ...
    sourceUrl:
      'https://www.berklee.edu/sites/default/files/2025-02/CDS_2024-2025%20for%20print.pdf',
    lastError:
  ...
  },
  {
    ...
    sourceUrl:
      'https://www.scad.edu/about/institutional-effectiveness/office-institutional-research',
    lastError:
