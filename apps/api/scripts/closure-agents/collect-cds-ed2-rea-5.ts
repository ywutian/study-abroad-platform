...
const BATCH: SchoolEntry[] = [
  ...
  },
  {
    ...
    rea: {
      ...
      value: false,
      sourceUrl:
        'https://www.smu.edu/admission/apply/undergraduate-admission/process',
      confidence: 0.95,
      tier: 'SCRAPED',
  ...
  },
  {
    ...
    ed2: {
      ...
      status: 'UNAVAILABLE',
      sourceUrl:
        'https://www.umass.edu/admissions/undergraduate-admissions/apply/important-dates-deadlines',
      lastError:
    ...
    rea: {
      ...
      value: false,
      sourceUrl:
        'https://www.umass.edu/admissions/undergraduate-admissions/apply/admission-decision/early-action-faq',
      confidence: 0.96,
      tier: 'SCRAPED',
  ...
  },
  {
    ...
    ed2: {
      ...
      status: 'UNAVAILABLE',
      sourceUrl:
        'https://www.sandiego.edu/admission-and-aid/undergraduate/apply/admission-timeline.php',
      lastError:
