...
export enum AuditAction {
  ...
  // Theme style governance
  THEME_STYLE_SAVE = 'THEME_STYLE_SAVE',
  THEME_STYLE_UPDATE = 'THEME_STYLE_UPDATE',
  THEME_STYLE_ROLLBACK = 'THEME_STYLE_ROLLBACK',
  THEME_STYLE_VALIDATE_FAILED = 'THEME_STYLE_VALIDATE_FAILED',
}
