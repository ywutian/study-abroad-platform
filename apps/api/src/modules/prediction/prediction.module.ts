...
import { PredictionBenchmarkModule } from './benchmark/benchmark.module';
...
@Module({
  imports: [
    ...
    OutcomeModule,
    // M3 benchmark co-review — admin surface showing structural test + v3
    // case replay results, free-form review comments from multiple admins.
    PredictionBenchmarkModule,
