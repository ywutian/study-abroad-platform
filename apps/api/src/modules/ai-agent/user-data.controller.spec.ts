...
describe('UserDataController', () => {
  ...
  describe('GET /memories', () => {
    it('should return paginated memories', async () => {
      ...
      const result = await controller.getMemories(
        mockUser as any,
        query as any,
      );
  ...
  describe('GET /memories/:id', () => {
    it('should return a single memory', async () => {
      const result = await controller.getMemory(mockUser as any, 'mem-1');
  ...
  describe('DELETE /memories/:id', () => {
    it('should delete a single memory', async () => {
      await controller.deleteMemory(mockUser as any, 'mem-1');
  ...
  describe('POST /memories/batch-delete', () => {
    it('should batch delete memories', async () => {
      ...
      const result = await controller.batchDeleteMemories(
        mockUser as any,
        body as any,
      );
  ...
  describe('DELETE /memories', () => {
    it('should clear all memories', async () => {
      const result = await controller.clearAllMemories(mockUser as any);
  ...
  describe('DELETE /conversations/:id', () => {
    it('should delete a conversation', async () => {
      await controller.deleteConversation(mockUser as any, 'conv-1');
  ...
  describe('DELETE /conversations', () => {
    it('should clear all conversations', async () => {
      const result = await controller.clearAllConversations(mockUser as any);
  ...
  describe('GET /entities', () => {
    it('should return paginated entities', async () => {
      const query = { page: 1, limit: 10 };
      const result = await controller.getEntities(
        mockUser as any,
        query as any,
      );
  ...
  describe('DELETE /entities/:id', () => {
    it('should delete an entity', async () => {
      await controller.deleteEntity(mockUser as any, 'ent-1');
  ...
  describe('DELETE /entities', () => {
    it('should clear all entities', async () => {
      const result = await controller.clearAllEntities(mockUser as any);
  ...
  describe('POST /preferences/reset', () => {
    it('should reset preferences and return defaults', async () => {
      const result = await controller.resetPreferences(mockUser as any);
  ...
  describe('POST /export', () => {
    it('should export user data', async () => {
      ...
      const result = await controller.exportData(mockUser as any, body as any);
  ...
  describe('GET /export/download', () => {
    it('should set Content-Disposition header and send JSON', async () => {
      await controller.downloadExport(mockUser as any, mockResponse as any);
  ...
  describe('POST /clear', () => {
    it('should clear specified data categories', async () => {
      ...
      const result = await controller.clearData(mockUser as any, body as any);
  ...
  describe('DELETE /all', () => {
    it('should clear all AI data', async () => {
      const result = await controller.clearAllData(mockUser as any);
