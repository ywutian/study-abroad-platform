...
export const TOOL_METADATA = {
  ...
  [ToolName.REVIEW_ESSAY]: toolMetadata('generate', 'medium', false),
  [ToolName.POLISH_ESSAY]: toolMetadata('generate', 'medium', false),
  [ToolName.GENERATE_OUTLINE]: toolMetadata('generate', 'low', false),
  [ToolName.BRAINSTORM_IDEAS]: toolMetadata('generate', 'medium', false),
  ...
  [ToolName.RECOMMEND_SCHOOLS]: toolMetadata('generate', 'medium', false),
  ...
  [ToolName.REVIEW_RESUME]: toolMetadata('generate', 'medium', false),
  [ToolName.OPTIMIZE_RESUME_BULLETS]: toolMetadata('generate', 'medium', false),
  [ToolName.SUGGEST_RESUME_CONTENT]: toolMetadata('generate', 'medium', false),
