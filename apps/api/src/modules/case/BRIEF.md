...
PrismaService, CaseQueryService, CaseBatchService, CaseMemoryService, CaseIncentiveService (@Optional) | AI/LLM: Indirect (feeds prediction model)
...
- Points awarded for case submission via CaseIncentiveService
- Data review pipeline: staging → approved/rejected (admin-controlled)

## Gotchas

- CaseIncentiveService is `@Optional()` — works without points system
