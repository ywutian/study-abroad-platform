...
const schools = [
  {
    ...
    metadata: {
      provenance: {
        acceptanceRate: { source: 'COLLEGE_SCORECARD', at: SEED_PROVENANCE_AT },
        satAvg: { source: 'COLLEGE_SCORECARD', at: SEED_PROVENANCE_AT },
        tuition: { source: 'IPEDS', at: SEED_PROVENANCE_AT },
        graduationRate: { source: 'IPEDS', at: SEED_PROVENANCE_AT },
        retentionRate: { source: 'COLLEGE_SCORECARD', at: SEED_PROVENANCE_AT },
      },
    },
  },
  {
    ...
    metadata: {
      ...
      provenance: {
        ...
        ...(reqs.toeflMin !== undefined
          ? { toeflMin: { source: 'SEED', at: SEED_PROVENANCE_AT } }
          : {}),
        ...(reqs.ieltsMin !== undefined
          ? { ieltsMin: { source: 'SEED', at: SEED_PROVENANCE_AT } }
          : {}),
