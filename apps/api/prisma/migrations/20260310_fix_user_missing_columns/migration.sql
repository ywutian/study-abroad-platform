...
-- ============================================
-- Everything below is from 20260309_fix_production_schema (which failed to apply).
...
DO $$ BEGIN ALTER TABLE "ReviewReaction" ADD CONSTRAINT "ReviewReaction_reviewId_fkey" FOREIGN KEY ("reviewId") REFERENCES "Review"("id") ON DELETE CASCADE ON UPDATE CASCADE; EXCEPTION WHEN duplicate_object OR undefined_table THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE "ReviewReaction" ADD CONSTRAINT "ReviewReaction_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE; EXCEPTION WHEN duplicate_object OR undefined_table THEN NULL; END $$;

-- Team tables
CREATE TABLE IF NOT EXISTS "Team" (
    "id" TEXT NOT NULL, "creatorId" TEXT NOT NULL, "name" TEXT NOT NULL,
    "description" TEXT, "schoolId" TEXT, "tags" JSONB,
    "visibility" "TeamVisibility" NOT NULL, "joinPolicy" "TeamJoinPolicy" NOT NULL,
    "maxMembers" INTEGER, "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS "TeamMembership" (
    ...
    "role" "TeamMemberRole" NOT NULL, "joinedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS "TeamInvitation" (
    "id" TEXT NOT NULL, "teamId" TEXT NOT NULL, "inviterId" TEXT NOT NULL,
    "inviteeId" TEXT, "token" TEXT, "status" "TeamInvitationStatus" NOT NULL DEFAULT 'PENDING',
...
CREATE TABLE IF NOT EXISTS "Resume" (
    "id" TEXT NOT NULL, "userId" TEXT NOT NULL, "title" TEXT NOT NULL DEFAULT 'My Resume',
    "status" "ResumeStatus" NOT NULL DEFAULT 'DRAFT', "type" "ResumeType" NOT NULL DEFAULT 'COLLEGE_APPLICATION',
    "templateId" TEXT NOT NULL DEFAULT 'jake-classic', "language" TEXT NOT NULL DEFAULT 'en',
    "settings" JSONB NOT NULL DEFAULT '{}', "version" INTEGER NOT NULL DEFAULT 1,
    "lastImportedAt" TIMESTAMP(3), "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE IF NOT EXISTS "ResumeSection" (
    "id" TEXT NOT NULL, "resumeId" TEXT NOT NULL, "type" "ResumeSectionType" NOT NULL,
    "title" TEXT NOT NULL, "content" JSONB NOT NULL, "isVisible" BOOLEAN NOT NULL DEFAULT true,
...
CREATE TABLE IF NOT EXISTS "ResumeSnapshot" (
    "id" TEXT NOT NULL, "resumeId" TEXT NOT NULL, "version" INTEGER NOT NULL,
    "data" JSONB NOT NULL, "description" TEXT, "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS "ResumeAIReview" (
    "id" TEXT NOT NULL, "resumeId" TEXT NOT NULL, "type" TEXT NOT NULL,
    "input" JSONB NOT NULL, "output" JSONB NOT NULL, "overallScore" INTEGER,
    "tokenUsed" INTEGER NOT NULL DEFAULT 0, "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS "Payment" (
    "id" TEXT NOT NULL, "userId" TEXT NOT NULL, "orderId" TEXT NOT NULL,
    "amount" INTEGER NOT NULL, "currency" TEXT NOT NULL DEFAULT 'CNY',
    "status" TEXT NOT NULL DEFAULT 'PENDING', "provider" TEXT NOT NULL DEFAULT 'stripe',
    "metadata" JSONB, "paidAt" TIMESTAMP(3), "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
