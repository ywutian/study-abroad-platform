...
export const colors = {
  light: {
    ...sharedColors.light,
    successForeground: '#fff7ea',
    warningForeground: '#1d1813',
    errorForeground: '#fff7ea',
    infoForeground: '#fff7ea',
  ...
  dark: {
    ...sharedColors.dark,
    successForeground: '#191510',
    warningForeground: '#191510',
    errorForeground: '#191510',
    infoForeground: '#191510',
