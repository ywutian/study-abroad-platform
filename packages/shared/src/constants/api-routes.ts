...
export const schoolRoutes = {
  ...
  rankingLists: () => `${API_ROUTES.SCHOOLS}/ranking-lists`,
  mediaCoverage: () => `${API_ROUTES.SCHOOLS}/admin/media-coverage`,
  mediaAssets: () => `${API_ROUTES.SCHOOLS}/admin/media-assets`,
  mediaDiscover: () => `${API_ROUTES.SCHOOLS}/admin/media/discover`,
  mediaApprove: (assetId: string) => `${API_ROUTES.SCHOOLS}/admin/media-assets/${assetId}/approve`,
  mediaReject: (assetId: string) => `${API_ROUTES.SCHOOLS}/admin/media-assets/${assetId}/reject`,
  mediaSetPrimary: (assetId: string) =>
    `${API_ROUTES.SCHOOLS}/admin/media-assets/${assetId}/set-primary`,
  mediaRetry: (assetId: string) => `${API_ROUTES.SCHOOLS}/admin/media-assets/${assetId}/retry`,
...
export const adminRoutes = {
  ...
  // Prediction diag/benchmark route helpers removed 2026-05-07 along with
  // the ML platform layer (admin/predictions/diag/* and benchmark/*
  // controllers were deleted; counselor mode is the served path).
