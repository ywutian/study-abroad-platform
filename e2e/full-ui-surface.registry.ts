...
export const FULL_UI_SURFACE_ROUTES: FullUiSurfaceRoute[] = [
  ...
  {
    name: 'Counselor patterns',
    pattern: '/counselor/patterns',
    path: '/counselor/patterns',
    role: 'admin',
  },
  ...
  { name: 'Schools', pattern: '/schools', path: '/schools', role: 'guest', critical: true },
  {
    ...
    path: '/schools/compare?ids=e2e-mit,e2e-stanford',
    role: 'guest',
    critical: true,
  },
  {
  ...
  {
    name: 'Admin debate evaluation',
    pattern: '/admin/debate-eval',
    path: '/admin/debate-eval',
    role: 'admin',
  },
  ...
  {
    name: 'Admin outcomes verification',
    pattern: '/admin/outcomes-verification',
    path: '/admin/outcomes-verification',
    role: 'admin',
  },
